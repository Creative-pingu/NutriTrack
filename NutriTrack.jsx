...
export default function NutriTrack() {
  ...
  useEffect(() => {
    const probe = () => {
      ...
      return fetch(`${WORKER_URL}/health`, { method: "GET", cache: "no-store", signal: controller.signal })
  ...
  if (view === "log") {
    ...
    return (
      <div style={S.app}>
        ...
        <div style={{background:"#0f172a",borderBottom:"1px solid #1e293b",padding:"4px 14px",fontSize:10,color:"#475569",flexShrink:0}}>
          debug: isOnline={String(isOnline)} navOnLine={String(typeof navigator!=="undefined"?navigator.onLine:"?")}
        </div>
        {!isOnline && (
