...
const CACHE_VERSION = "nutritrack-v10";
...
self.addEventListener("fetch", event => {
  ...
  // 3. App-shell assets (same-origin under /NutriTrack/ OR cross-origin CDN precache)
  ...
  // 4. Everything else same-origin — network-first, fall back to cache.
