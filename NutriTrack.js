...
const CUSTOM_FOOD_TO_DB = [["cal", "calories"], ["pro", "protein"], ["carb", "carbohydrates"], ["fat", "fat"], ["fib", "fibre"], ["alc", "alcohol"],
// Phase 11
["water", "water"],
// Phase 11
...
export default function NutriTrack() {
  ...
  if (view === "log") {
    ...
    }, "· ", fmtE(Math.round(alcTotalG * 7 * 10) / 10), " ", energyLabel))))), exerciseBurn > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        margin: "0 20px 8px",
        background: "#0f2d1a",
    ...
    }), dayLog.filter(e => e.type !== "exercise" && e.type !== "supplement" && e.type !== "water" && e.type !== "alcohol").length === 0 && !suppEntries.length && /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        padding: "40px 0",
        color: "#475569"
