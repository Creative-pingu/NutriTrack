...
function NutriTrack() {
  ...
  if (view === "log") {
    ...
    }), dayLog.filter(e => e.type !== "exercise" && e.type !== "supplement").length === 0 && !suppEntries.length && /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        padding: "40px 0",
        color: "#475569"
  ...
  if (view === "add") {
    const ModePicker = () => /*#__PURE__*/React.createElement("div", {
      style: S.modePicker
    }, [["food", "🍎 Food"], ["recipe", "📖 Recipe"], ["supplement", "💊 Supps"]].map(([m, label]) => /*#__PURE__*/React.createElement("button", {
      key: m,
  ...
  if (view === "recipeCreate") {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, ing.amount_g, "g · ", ingCal, " ", energyLabel)), /*#__PURE__*/React.createElement("button", {
        style: {
          background: "none",
          border: "none",
          color: "#ef4444",
  ...
  if (view === "goals") {
    ...
    }, "Fat: ", goals.fat, "g (25% TDEE ÷ 9) · Carbs: ", goals.carb, "g (residual) · Fibre: ", goals.fib, "g (14g/1000kcal)")))), sections.map(({
      title,
      keys
    }) => /*#__PURE__*/React.createElement("div", {
      key: title,
  ...
  if (view === "manageCustomFoods") {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: S.section
    }, active.length === 0 && deleted.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        padding: "40px 0",
        color: "#475569"
